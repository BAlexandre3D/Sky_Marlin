...
#define STRING_CONFIG_H_AUTHOR "(Skysqual B.A)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Hephaestos V1 IDEX"
 ...
 */
//#define PSU_CONTROL
#define PSU_NAME "Power Supply 24V 360W"
...
#define Z_PROBE_FEEDRATE_FAST (40*60/4)

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (40*60/8)
...
#define XY_AFTER_HOMING { X_MIN_POS+5, Y_MAX_POS-5 }  // (mm) Move to an XY position after homing (and raising Z)
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_STROKES     12   // Default number of pattern repetitions
    ...
    #define NOZZLE_CLEAN_TRIANGLES  5   // Default number of triangles
  #endif

  // Specify positions for each tool as { { X, Y, Z }, { X, Y, Z } }
  // Dual hotend system may use { {  -20, (Y_BED_SIZE / 2), (Z_MIN_POS + 1) },  {  420, (Y_BED_SIZE / 2), (Z_MIN_POS + 1) }}
  #define NOZZLE_CLEAN_START_POINT { {  245, -22, (Z_MIN_POS + 6.5) } }
  #define NOZZLE_CLEAN_END_POINT   { { 290, -22, (Z_MIN_POS + 6.5) } }
