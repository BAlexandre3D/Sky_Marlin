...
#define CUSTOM_MACHINE_NAME "Hephaestos V0"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -50, -20, -1.65 }
...
#define XY_AFTER_HOMING { 10, Y_MAX_POS-10 }  // (mm) Move to an XY position after homing (and raising Z)
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_TYPE               123// NEO_GRBW, NEO_RGBW, NEO_GRB, NEO_RBG, etc.
